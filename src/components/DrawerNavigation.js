...
const MyDrawer = () => {
  return (
    ...
    >
      ...
      <Drawer.Screen name="Devices" component={DevicesScreen} initialParams={{"new": true, "loading": true}} />
      <Drawer.Screen name="Raw Data" component={RawDataScreen}  initialParams={{"new": true, "loading": true}} />
